...
omp_num_threads=8 ./omp_ocean_static_increment 2 2 100 0 0 2

omp_num_threads=8 ./omp_ocean_static_increment 4 4 100 0 0 4

omp_num_threads=8 ./omp_ocean_static_increment 8 8 100 0 0 8 

omp_num_threads=8 ./omp_ocean_static_increment 16 16 100 0 0 16

omp_num_threads=8 ./omp_ocean_static_increment 32 32 100 0 0 32

omp_num_threads=8 ./omp_ocean_static_increment 64 64 100 0 0 64

omp_num_threads=8 ./omp_ocean_static_increment 128 128 100 0 0 128

omp_num_threads=8 ./omp_ocean_static_increment 256 256 100 0 0 256

omp_num_threads=8 ./omp_ocean_static_increment 512 512 100 0 0 512

omp_num_threads=8 ./omp_ocean_static_increment 1024 1024 100 0 0 1024
